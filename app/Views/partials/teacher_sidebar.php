<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container-fluid">
        ...
        <a class="navbar-brand d-flex align-items-center" href="<?= esc($dashboardUrl) ?>">
            ...
            <span class="fw-bold">Learnify Teacher</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="teachingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" class="me-1">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="teachingDropdown">
                        <li><a class="dropdown-item" href="<?= site_url('teacher/courses') ?>">
                            <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" class="me-2">
                                <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                            </svg>
                            My Courses
                        </a></li>
                        <li><a class="dropdown-item" href="<?= site_url('teacher/create-course') ?>">
                            <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" class="me-2">
                                <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/>
                            </svg>
                            Create Course
                        </a></li>
                        <li><a class="dropdown-item" href="<?= site_url('teacher/students') ?>">
                            <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" class="me-2">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="assessmentDropdown">
                        <li><a class="dropdown-item" href="<?= site_url('teacher/assignments') ?>">
                            <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" class="me-2">
                                <path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 2 2h8c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-1 10H7v-2h6v2zm0-3H7V7h6v2z"/>
                            </svg>
                            Assignments
                        </a></li>
                        <li><a class="dropdown-item" href="<?= site_url('teacher/gradebook') ?>">
                            <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" class="me-2">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="communicationDropdown">
                        <li><a class="dropdown-item" href="<?= site_url('teacher/announcements') ?>">
                            <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" class="me-2">
                                <path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z"/>
                            </svg>
                            Announcements
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="analyticsDropdown">
                        <li><a class="dropdown-item" href="<?= site_url('teacher/analytics') ?>">
                            <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" class="me-2">
                                <path d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zM7 7v2h14V7H7z"/>
                            </svg>
                            Course Analytics
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="accountDropdown">
                        <li><a class="dropdown-item" href="<?= site_url('teacher/profile') ?>">
                            <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" class="me-2">
                                <path d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-4 0-8 2-8 6v2h16v-2c0-4-4-6-8-6z"/>
                            </svg>
                            Profile
